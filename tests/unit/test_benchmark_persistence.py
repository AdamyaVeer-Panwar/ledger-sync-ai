...
def test_persist_and_load_result(tmp_path, monkeypatch):
    ...
    results_file = results_dir / "llm_baseline_results.jsonl"
    ...
    assert restored.candidate_id == "L001"
...
def test_load_completed_results_skips_malformed_lines(
    ...
    results_file.write_text(
        ...
        {"settlement_id":"S002","expected":null,"decision":"NO_MATCH","candidate_id":null,"confidence":0.1,"candidate_count":0,"latency_seconds":0.2,"input_tokens":10,"output_tokens":5,"total_tokens":15,"error_type":null,"error_message":null}
        """,
        encoding="utf-8",
    )
